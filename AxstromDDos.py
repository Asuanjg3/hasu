...
def title():
    #sys.stdout.write("\x1b]2;Axstrom Ghost | User: root\x07")
    stdout.write("                                                                                          \n")
    ...
    stdout.write("             \x1b[38;2;255;0;0m║ \x1b[38;2;0;255;189m        Welcome To The Main Screen Of Axstrom Ghost\x1b[38;2;255;0;0m         ║\n")
...
def command():
    stdout.write(Fore.LIGHTMAGENTA_EX+"╔═══"+Fore.MAGENTA+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.MAGENTA+"Axstrom Ghost"+Fore.MAGENTA+"]"+Fore.LIGHTMAGENTA_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
    if command == "cls":
        clear()
        title()
